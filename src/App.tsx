...
export default function App() {
  ...
  const handleRunSolver = useCallback(
    (simulations: number) => {
      // Samla ihop alla kort som redan ligger på mitt bräde — de är "aktuella kort" att lösa
      // Men solvern behöver veta vilka kort att placera.
      // Användaren väljer kort via CardPicker och placerar dem manuellt.
      // Solver ska rekommendera var NÄSTA kort ska läggas baserat på aktuellt bräde.

      // Om vi har ett valt kort: kör solver med det kortet
      if (selectedCard) {
        runSolver({
          board: myBoard,
          cards: [selectedCard],
      ...
      // Om vi har kort i currentCards (Pineapple / FL): kör solver med dessa
    ...
    [selectedCard, currentCards, myBoard, deadCards, variant, runSolver],
  );
